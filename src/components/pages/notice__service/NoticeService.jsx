                ...
                <>
                    {user && user.role === 'ADMIN' && (
                        <div className="admin-notice">
                            <Link to ="/admin/notice/writeNotice " className={thirdSegment === 'writeNotice' ? 'in' : ''}>공지 작성</Link>
                    ...
                    {user && user.role === 'PROFESSOR' && (
                        <div className="professor-notice">
                            <Link to ="/professor/notice/writeNotice" className={thirdSegment === 'writeNotice' ? 'in' : ''}>공지 작성</Link>
